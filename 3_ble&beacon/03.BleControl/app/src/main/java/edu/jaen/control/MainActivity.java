...
//			testButton1();
	...
	private void testButton() {
		// 1. 데이터를 수신할 구성정보(Characteristic) 기능 활성화. conf를 활성화 시켜야 센싱을 시작
		...
		gatt.setCharacteristicNotification(c, true); // 다 gatt를 통해서 내리는 것을 확인 가능.
		// 3. 데이터의 CCCD값을 활성화 -> 이제 이때부터 전송 시작.
